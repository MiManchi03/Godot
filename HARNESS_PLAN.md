...
### [2026-09-14] Harness Phase 1 落地
- **决策**: 术语闸口复活 + Harness 资产入库 + pre-commit hook 安装
- **依据**: 审计 A1/A2/A3/A4/A7；红队演练 Gate A（术语闸口崩溃）
- **状态**: ✅ 已落地
...
### [2026-09-14] Harness Phase 2 落地
- **决策**: 架构闸口（_process 每帧分配 + 跨脚本私有成员访问）+ 依赖白名单闸口 + git 权限收窄
- **依据**: 演练 D1；审计 A6/A11/A12
- **状态**: ✅ 已落地

### [2026-09-14] Harness Phase 3 落地
- **决策**: 范围守卫 + 活文档新鲜度 + 测试声明取证；agent 增“完成取证”条款
- **依据**: 演练 D4/D5/D7；审计 A9/A13
- **状态**: ✅ 已落地

### [2026-09-14] Harness Phase 4 落地
- **决策**: 接入 GUT 单测（17 项）+ gdtoolkit gdlint + 一键 verify.sh；CI 改为真实校验
- **依据**: 演练 D2/D3；审计 A5/A6/A14
- **状态**: ✅ 已落地
- **附带**: 修正 VillageService 非法语法（?./??）与同名 class_name 冲突
